/**
 * South Dakota (SD) — local employee-side state wage tax estimate (TY 2026).
...
export function estimateSouthDakotaStateTax(_params: StateTaxEstimateInput): StateTaxAnnualParts {
  return zeroStateTax("SD", "No state individual income tax on wages (TY 2026).");
}
