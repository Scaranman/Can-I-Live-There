/**
 * New Hampshire (NH) — local employee-side state wage tax estimate (TY 2026).
...
export function estimateNewHampshireStateTax(_params: StateTaxEstimateInput): StateTaxAnnualParts {
  return zeroStateTax("NH", "No state individual income tax on wages (TY 2026).");
}
