/**
 * Texas (TX) — local employee-side state wage tax estimate (TY 2026).
...
export function estimateTexasStateTax(_params: StateTaxEstimateInput): StateTaxAnnualParts {
  return zeroStateTax("TX", "No state individual income tax on wages (TY 2026).");
}
