/**
 * Tennessee (TN) — local employee-side state wage tax estimate (TY 2026).
...
export function estimateTennesseeStateTax(_params: StateTaxEstimateInput): StateTaxAnnualParts {
  return zeroStateTax("TN", "No state individual income tax on wages (TY 2026).");
}
