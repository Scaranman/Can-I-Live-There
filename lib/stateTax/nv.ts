/**
 * Nevada (NV) — local employee-side state wage tax estimate (TY 2026).
...
export function estimateNevadaStateTax(_params: StateTaxEstimateInput): StateTaxAnnualParts {
  return zeroStateTax("NV", "No state individual income tax on wages (TY 2026).");
}
