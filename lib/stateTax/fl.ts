/**
 * Florida (FL) — local employee-side state wage tax estimate (TY 2026).
...
export function estimateFloridaStateTax(_params: StateTaxEstimateInput): StateTaxAnnualParts {
  return zeroStateTax("FL", "No state individual income tax on wages (TY 2026).");
}
