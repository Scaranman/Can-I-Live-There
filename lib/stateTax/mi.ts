/**
 * Michigan (MI) — local employee-side state wage tax estimate (TY 2026).
...
const PERSONAL_EXEMPTION = { single: 5900, married: 11800, hoh: 5900 };
const RATE = 0.0425;

export function estimateMichiganStateTax(params: StateTaxEstimateInput): StateTaxAnnualParts {
