/**
 * Iowa (IA) — local employee-side state wage tax estimate (TY 2026).
...
export function estimateIowaStateTax(params: StateTaxEstimateInput): StateTaxAnnualParts {
