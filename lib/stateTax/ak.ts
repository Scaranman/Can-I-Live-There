/**
 * Alaska (AK) — local employee-side state wage tax estimate (TY 2026).
...
export function estimateAlaskaStateTax(_params: StateTaxEstimateInput): StateTaxAnnualParts {
  return zeroStateTax("AK", "No state individual income tax on wages (TY 2026).");
}
